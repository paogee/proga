...
int main()
{
	...
	cout << "</head>";
	cout << "<body> \n";
	cout << "<h3>Form processing</h3>" << endl;;	
	cout << "<form method=\"get\" action=\"parser3.cgi\">" << endl;
	...
	return 0;
	//cout <<"<table>"<< endl;
	cout<< "<label for=\"rmb\">Remember you?</label>"<<endl;
	cout << "<input type=\"hidden\" name=\"rmb\" id=\"rmb\"> value=\"False\" <br>/>" << endl;
	cout << "<input type=\"checkbox\" name=\"rmb\" id=\"rmb\"> value=\"True\" <br>/>" << endl;
	
	cout<< "<label for=\"fav\">Favourite wine?</label> <br>"<<endl;
	cout << "< input type=\"radio\" name=\"red\" value=\"red\"> Red </label> <br>"<<endl;
	cout << "< input type=\"radio\" name=\"white\" value=\"white\"> White </label> <br>"<<endl;
	cout << "< input type=\"radio\" name=\"rose\" value=\"rose\"> Rose </label> <br>"<<endl;
